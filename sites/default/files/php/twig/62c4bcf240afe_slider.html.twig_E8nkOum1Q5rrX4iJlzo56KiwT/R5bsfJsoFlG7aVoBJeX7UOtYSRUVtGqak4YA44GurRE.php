...
class __TwigTemplate_964a7aa2cd7f33bfcc5d983a4ccbcc6a8bc0cbafce64d3ea6f4688c30c5c7d6b extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <ul class=\"js-rotating\">
      ";
        ...
        if ((($context["slider_code"] ?? null) != "")) {
            // line 5
            echo "        ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(twig_striptags($this->sandbox->ensureToStringAllowed(($context["slider_code"] ?? null), 5, $this->source), "<ol>,<ul>,<li>,<p>,<a>,<img>,<video>,<h1>,<h2>,<h3>,<h4>,<h5>,<h6>,<em>,<strong>,<br>,<i>,<button>,<mark>"));
            echo "
      ";
        } else {
            // line 7
...
";
    ...
    {
        return new Source("", "@mili/template-parts/slider.html.twig", "/home/u692838125/domains/ukua.xyz/public_html/themes/mili/templates/template-parts/slider.html.twig");
    }
